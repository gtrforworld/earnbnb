...
export default function Home() {
  ...
  useEffect(() => {
    document.title = "BNB - " + process.env.NEXT_PUBLIC_APPS_NAME;
  }, [])
                            ...
                            <div className="col-lg-12">
                                <div className="blog-post-wrapper" style={{width: '100%'}} >
                                    <div className="tournament__details-content">
                                        <h2 className="title">
                                            <Image style={{marginBottom: "0.5rem"}} src={IconBnb} width={60} height={60}/>
                                            &nbsp; Instructions
                                        </h2>
                                        <blockquote className="blockquoteclass"><p>Send an amount (BNB BEP20) to the address:</p></blockquote>
                                        <p>
                                        ...
                                        <p>
                                            Min. amount: <span className="instructionPercent">0.02 BNB</span>;
                                        </p>
