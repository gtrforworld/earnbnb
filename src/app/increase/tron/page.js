...
export default function Home() {
  ...
  useEffect(() => {
    document.title = "Tron - " + process.env.NEXT_PUBLIC_APPS_NAME;
  }, [])

  const { Canvas } = useQRCode();

  var toAddress = "TJ6Z8RFntaMGEVUsAB4TkPP2dD68t8kFRu";
  return (
   <>
    <Header menu={'home'}/>
                            ...
                            <div className="col-lg-12">
                                <div className="blog-post-wrapper" style={{width: '100%'}} >
                                    <div className="tournament__details-content">
                                        <h2 className="title">
                                            <Image style={{marginBottom: "0.5rem"}} src={IconTrx} width={60} height={60}/>
                                            &nbsp; Instructions
                                        </h2>
                                        <blockquote className="blockquoteclass"><p>Send an amount (Tron TRC20) to the address:</p></blockquote>
                                        <p>
                                        ...
                                        <p>
                                            Min. amount: <span className="instructionPercent">50 TRX</span>;
                                        </p>
